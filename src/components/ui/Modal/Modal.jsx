    ...
    {estado && 
        <div className = "Overlay">
            <div className="ContenedorModal">
                ...
                <form action='' className="form2Sing2" onSubmit={(e) => onSubmit(e)}>

                    <input onChange={(e) => onChange(e)} placeholder='Nombre de Usuario' name='name' type='text' id='nameUser' required />
                    <input onChange={(e) => onChange(e)} placeholder='Contraseña nueva' name='password' type='password' id='password' required />
                    <input onChange={(e) => onChange(e)} placeholder='Correo nuevo' name='email' type='email' id='emailSing' required />
